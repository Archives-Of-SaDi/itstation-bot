...
import { MyContext, bot } from '../core/bot.ts';
import { aboutCoursesKeyboard, startKeyboard, check } from '../utils/keyboards.ts';
...
phoneNumber2.on('message:text', ctx => {
  ...
  ctx.reply('Kurs yo\'nalishini tanlang', { reply_markup: aboutCoursesKeyboard });
